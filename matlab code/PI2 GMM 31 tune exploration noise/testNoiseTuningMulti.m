...
vNoiseNormRec = zeros(20,10,10);
vNoiseNormBasic = zeros(20,10,10);
for n = 1:10
    n
   % epsilonRec = produceExplorationNoise(1,GMR,0);
   epsilonRec = produceExplorationNoiseRatio(10,GMR,0);
   epsilonBasic = randn(n_params,1)*10;
...
% figure
% hold on
% surf(-14:1:5,-4:1:5,-vNoiseNormMeanRec')
% cmap = colormap;
% cmap = flipud(cmap);
% colormap(cmap);
% my_plotGMM(GMR.muInput, GMR.sigmaInput, 'r', 1);
...
% figure
% hold on
% surf(-14:1:5,-4:1:5,-vNoiseNormMeanBasic')
% cmap = colormap;
% cmap = flipud(cmap);
% colormap(cmap);
% my_plotGMM(GMR.muInput, GMR.sigmaInput, 'r', 1);
...
figure
hold on
surf(-14:1:5,-4:1:5,-vNoiseNormRatioMeanRec')
cmap = colormap;
cmap = flipud(cmap);
colormap(cmap);
my_plotGMM(GMR.muInput, GMR.sigmaInput, 'r', 1);
...
figure
hold on
surf(-14:1:5,-4:1:5,-vNoiseNormRatioMeanBasic')
cmap = colormap;
cmap = flipud(cmap);
colormap(cmap);
my_plotGMM(GMR.muInput, GMR.sigmaInput, 'r', 1);
...
figure
hold on
surf(-14:1:5,-4:1:5,-vBaselineNorm')
cmap = colormap;
cmap = flipud(cmap);
colormap(cmap);
my_plotGMM(GMR.muInput, GMR.sigmaInput, 'r', 1);
