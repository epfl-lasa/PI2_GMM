...
for k=1:n_rep,
    for m= 1:n_subtrials
      ...
      [minVal, Index] =  min((D(k,m).q(1,1:n_steps_real)-2).^2+(D(k,m).q(2,1:n_steps_real)-0).^2);
      viapointCostSteps(Index,k,m) = viapointCostSteps(Index,k,m)+ viapointCostWeight* minVal;
      [minVal, Index] =  min((D(k,m).q(1,1:n_steps_real)-4).^2+(D(k,m).q(2,1:n_steps_real)-0).^2);
      viapointCostSteps(Index,k,m) = viapointCostSteps(Index,k,m)+ viapointCostWeight* minVal;
      [minVal, Index] =  min((D(k,m).q(1,1:n_steps_real)-6).^2+(D(k,m).q(2,1:n_steps_real)-0).^2);
      viapointCostSteps(Index,k,m) = viapointCostSteps(Index,k,m)+ viapointCostWeight* minVal;
      [minVal, Index] =  min((D(k,m).q(1,1:n_steps_real)-6).^2+(D(k,m).q(2,1:n_steps_real)-2).^2);
      viapointCostSteps(Index,k,m) = viapointCostSteps(Index,k,m)+ viapointCostWeight* minVal;
      [minVal, Index] =  min((D(k,m).q(1,1:n_steps_real)-6).^2+(D(k,m).q(2,1:n_steps_real)-4).^2);
      viapointCostSteps(Index,k,m) = viapointCostSteps(Index,k,m)+ viapointCostWeight* minVal;
     
        % reach goal free time
        [minVal, Index] =  min((D(k,m).q(1,1:n_steps_real)-6).^2+(D(k,m).q(2,1:n_steps_real)-6).^2);
      viapointCostSteps(end,k,m) = viapointCostSteps(end,k,m)+ viapointCostWeight* minVal;
      
      % redundant final cost
...
viapointCostSteps = viapointCostSteps./2;
