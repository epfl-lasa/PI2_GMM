...
for k=1:n_rep,
    for m= 1:n_subtrials
      ...
      minVal = (D(k,m).q(1,40)+90).^2+(D(k,m).q(2,40)+10).^2;
      viapointCostSteps(40,k,m) = viapointCostSteps(40,k,m)+ viapointCostWeight* minVal;
      minVal = (D(k,m).q(1,70)+60).^2+(D(k,m).q(2,70)+130).^2;
      viapointCostSteps(70,k,m) = viapointCostSteps(70,k,m)+ viapointCostWeight* minVal;
