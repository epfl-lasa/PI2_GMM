function [genCostSteps, totCostSteps, userCostSteps, R, viapointCostSteps, accelerationCostSteps, controlCostSteps, convergenceCost] = viapoint_LineBumpSyncOnly(D,GMR,p)
...
for k=1:n_rep,
    for m= 1:n_subtrials
      ...
      minVal =(D(k,m).q(1,25)-2).^2+(D(k,m).q(2,25)-0).^2;
      viapointCostSteps(25,k,m) = viapointCostSteps(25,k,m)+ viapointCostWeight* minVal;
      minVal=(D(k,m).q(1,50)-4).^2+(D(k,m).q(2,50)-0).^2;
      viapointCostSteps(50,k,m) = viapointCostSteps(50,k,m)+ viapointCostWeight* minVal;
      minVal=(D(k,m).q(1,80)-6).^2+(D(k,m).q(2,80)-3).^2;
      viapointCostSteps(80,k,m) = viapointCostSteps(80,k,m)+ viapointCostWeight* minVal;
      minVal=(D(k,m).q(1,110)-8).^2+(D(k,m).q(2,110)-0).^2;
      viapointCostSteps(110,k,m) = viapointCostSteps(110,k,m)+ viapointCostWeight* minVal;
      

        % reach goal free time
      minVal=(D(k,m).q(1,end)-10).^2+(D(k,m).q(2,end)-0).^2;
