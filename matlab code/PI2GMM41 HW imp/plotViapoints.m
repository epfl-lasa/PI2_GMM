...
hold on
 ...
 %% Kuka dig
 hold on
scatter([-0.2 -0.1 -0.05],[-0.1 -0.15 -0.1], 80, 'g')
scatter([-0.2 -0.1 -0.05],[-0.1 -0.15 -0.1], 80, 'gx')

 %% Kuka dig 2
 hold on
scatter([-0.2 -0.1 -0.05],[-0.12 -0.15 -0.08], 80, 'g')
scatter([-0.2 -0.1 -0.05],[-0.12 -0.15 -0.08], 80, 'gx')